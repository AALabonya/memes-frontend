...
const Hero = () => {
  return (
        ...
        <div className="flex justify-center  md:flex-row flex-col md:gap-[40px] space-y-8 md:space-y-0 md:mb-12 mb-0 w-full max-w-[992px]">
          <div className="space-y-2 md:space-y-4">
            <div className="space-y-2">
              <h1 className="text-[40px] md:text-6xl font-bold md:leading-[60px] leading-0 text-center md:text-left">
                Buy Memes.
                <br />
                In Two Clicks.
              </h1>
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Info Card */}
            <div className="block w-full max-w-[300px] h-auto md:h-[104px]">
    ...
    //         <div className="space-y-2">
    //           <h1 className="text-[32px] md:text-[48px] lg:text-6xl font-bold md:leading-[60px] text-center md:text-left">
    //             Buy Memes.
    //             <br />
    //             In Two Clicks.
    //           </h1>
    //           <p className="text-[14px] md:text-[20px] lg:text-[24px] text-muted-foreground text-center md:text-left">
    //             The fastest way to buy memes in just two clicks.
    //             <br />
    //             Under 1 minute to sign up and no wallet needed.
    //           </p>
    ...
    //         <div className="block w-full max-w-[300px] h-auto md:h-[104px]">
    //           <div className="p-4 bg-white shadow-md rounded-md">
    //             <div className="flex flex-row items-start md:items-center justify-between mb-1">
    //               <span className="font-medium text-[18px] md:text-[20px]">
    //                 VIRTUAL
    //               </span>
    //               <span className="text-green-500 flex items-center gap-1 mt-2 md:mt-0">
